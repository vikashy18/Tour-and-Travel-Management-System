            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input required class="input--style-4" type="text" name="phone">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input required class="input--style-4" type="password" name="cpassword">
                                </div>
                            </div>
                        </div>
                        <div class="input-group">
                            ...
                            <select required name="stateslist">
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit" name="reg_user">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
