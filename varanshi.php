...
<body>
    ...
    <div class="headG">
        <center>
            <h2> GOLDEN TRIANGLE INDIA TOUR WITH VARANASI </h2>
        </center>
    </div>
    ...
    <br><br><br>
    <center>
            <b>Duration</b>: <span class="time_dur">5 Nights / 6 Days </span><br> <b>Destination Covered</b>: <span class="loc_dur">Varanshi</span>
